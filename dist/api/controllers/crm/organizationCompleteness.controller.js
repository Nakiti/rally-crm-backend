 ...
 */
export const checkOrganizationCompleteness = async (req, res, next) => {
    try {
 ...
 */
export const getOrganizationCompletenessStatus = async (req, res, next) => {
    try {
        const staffSession = req.user;
        if (!staffSession.organizationId) {
            throw new ApiError(400, 'User is not associated with any organization');
...
//# sourceMappingURL=organizationCompleteness.controller.js.map