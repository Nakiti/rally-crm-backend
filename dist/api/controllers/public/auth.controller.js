import { signUp as signUpService, logIn as logInService, createSession as createSessionService } from '../../services/public/auth.service.js';
const cookieOptions = {
    httpOnly: true,
...
export const signUp = async (req, res, next) => {
    try {
        const { organizationName, organizationSubdomain, firstName, lastName, email, password } = req.body;
