...
import { createDesignation, getAllDesignations, updateDesignation, archiveDesignation } from '../../controllers/crm/designation.controller.js';
import { validate } from '../../middleware/validate.js';
import { isStaffAuthenticated } from '../../middleware/isStaffAuthenticated.js';
import { hasRole } from '../../middleware/hasRole.js';
import { createDesignationSchema, updateDesignationSchema, archiveDesignationSchema } from './designation.schemas.js';
const router = Router();
/**
