...
import { getStaffForOrganization, inviteStaffMember, updateStaffRole, removeStaffFromOrganization } from '../../controllers/crm/staff.controller.js';
import { validate } from '../../middleware/validate.js';
import { isStaffAuthenticated } from '../../middleware/isStaffAuthenticated.js';
import { hasRole } from '../../middleware/hasRole.js';
import { inviteStaffSchema, updateStaffRoleSchema, removeStaffSchema } from './staff.schemas.js';
const router = Router();
