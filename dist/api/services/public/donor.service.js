...
export class PublicDonorService {
     ...
     */
    async getDonationHistoryForDonor(donorSession) {
        try {
            ...
            const publicDonationHistory = donationHistory.map(donation => ({
                id: donation.id,
...
export const getDonationHistoryForDonor = (donorSession) => publicDonorService.getDonationHistoryForDonor(donorSession);
