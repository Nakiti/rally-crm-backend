 ...
 */
export const createOrganizationPageForStaff = async (pageData, staffSession) => {
    try {
 ...
 * @param staffSession - The authenticated staff session
 */
export const getOrganizationPagesForOrg = async (staffSession) => {
    try {
        // Create repository instance with staff session for authorization
        const pageRepo = new CrmOrganizationPageRepository(staffSession);
 ...
 * @param staffSession - The authenticated staff session
 */
export const getOrganizationPageByIdForStaff = async (id, staffSession) => {
    try {
        // Create repository instance with staff session for authorization
        const pageRepo = new CrmOrganizationPageRepository(staffSession);
 ...
 * @param staffSession - The authenticated staff session
 */
export const getOrganizationPageByTypeForStaff = async (pageType, staffSession) => {
    try {
        // Create repository instance with staff session for authorization
        const pageRepo = new CrmOrganizationPageRepository(staffSession);
 ...
 * @param staffSession - The authenticated staff session
 */
export const updateOrganizationPageForStaff = async (id, updateData, staffSession) => {
    // Start a transaction
 ...
 * @param staffSession - The authenticated staff session
 */
export const deleteOrganizationPageForStaff = async (id, staffSession) => {
    try {
        // Create repository instance with staff session for authorization
        const pageRepo = new CrmOrganizationPageRepository(staffSession);
 ...
 * @param staffSession - The authenticated staff session
 */
export const getOrganizationPageContentConfig = async (id, staffSession) => {
    try {
        // Create repository instance with staff session for authorization
        const pageRepo = new CrmOrganizationPageRepository(staffSession);
        // Use repository to get organization page (includes authorization check)
 ...
 * @param staffSession - The authenticated staff session
 */
export const updateOrganizationPageContentConfig = async (id, contentConfig, staffSession) => {
    // Start a transaction
    const transaction = await sequelize.transaction();
    try {
        // Create repository instance with staff session for authorization
 ...
 * @param staffSession - The authenticated staff session
 */
export const publishOrganizationPage = async (pageSlug, contentConfig, staffSession) => {
    // Start a transaction
    const transaction = await sequelize.transaction();
    try {
        // Create repository instance with staff session for authorization
 ...
 */
export const createDefaultOrganizationPages = async (organizationId) => {
    try {
        const createdPages = [];
        ...
        const requiredPages = Object.keys(websitePageEditorConfig);
        ...
        for (const configPageType of requiredPages) {
            ...
            const defaultSections = pageConfig.availableSections.map(sectionType => {
                ...
                const sectionDefault = websiteSectionDefaults[sectionType];
