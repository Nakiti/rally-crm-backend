...
export class StripeService {
     ...
     */
    async createConnectAccount(organizationId, email) {
        try {
            ...
            await Organization.update({ stripeAccountId: account.id }, { where: { id: organizationId } });
            return account.id;
        }
        catch (error) {
     ...
     */
    async createDonationCheckoutSession(amount, campaignId, donorEmail, donorName, organizationId, successUrl, cancelUrl) {
        try {
    ...
    async handleAccountUpdated(account) {
        try {
            ...
            await Organization.update({ settings }, { where: { id: organization.id } });
