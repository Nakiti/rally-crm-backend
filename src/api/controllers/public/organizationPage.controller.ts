...
import { 
  getOrganizationPageByType,
  getOrganizationPageBySubdomainAndType,
  getOrganizationPages,
  getOrganizationPagesBySubdomain
} from '../../services/public/organizationPage.service.js';
 ...
 */
export const getOrganizationPageByTypeController = async (
  req: Request, 
  res: Response, 
  next: NextFunction
): Promise<void> => {
 ...
 */
export const getOrganizationPageBySubdomainAndTypeController = async (
  req: Request, 
  res: Response, 
  next: NextFunction
): Promise<void> => {
 ...
 */
export const getOrganizationPagesController = async (
  req: Request, 
  res: Response, 
  next: NextFunction
): Promise<void> => {
 ...
 */
export const getOrganizationPagesBySubdomainController = async (
  req: Request, 
  res: Response, 
  next: NextFunction
): Promise<void> => {
