...
import {
  createQuestion,
  getQuestionsForCampaign,
  updateQuestion,
  deleteQuestion
} from '../../controllers/crm/campaignQuestion.controller.js';
...
import {
  ...
  getQuestionsForCampaignSchema,
  deleteQuestionSchema
} from './campaignQuestion.schemas.js';
...
router.get('/', 
  isStaffAuthenticated, 
  hasRole(['admin', 'editor']), 
  validate(getQuestionsForCampaignSchema), 
  getQuestionsForCampaign
);
