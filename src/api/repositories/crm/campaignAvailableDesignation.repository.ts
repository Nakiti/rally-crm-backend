...
export class CrmCampaignAvailableDesignationRepository {
   ...
   */
  public async create(data: CampaignAvailableDesignationCreationAttributes): Promise<CampaignAvailableDesignation> {
    try {
   ...
   */
  public async findAllForCampaign(campaignId: string): Promise<CampaignAvailableDesignation[]> {
    try {
      // First verify that the campaign belongs to the organization
      const campaign = await Campaign.findOne({
        where: {
   ...
   */
  public async findByIdForOrg(id: string): Promise<CampaignAvailableDesignation | null> {
    try {
   ...
   */
  public async delete(id: string): Promise<CampaignAvailableDesignation> {
    try {
   ...
   */
  public async bulkCreate(campaignId: string, designationIds: string[]): Promise<CampaignAvailableDesignation[]> {
    try {
      // First verify that the campaign belongs to the organization
      const campaign = await Campaign.findOne({
        where: {
   ...
   */
  public async bulkDeleteByDesignationIds(campaignId: string, designationIds: string[]): Promise<number> {
    try {
      // First verify that the campaign belongs to the organization
      const campaign = await Campaign.findOne({
        where: {
   ...
   */
  public async getCurrentDesignationIds(campaignId: string): Promise<string[]> {
    try {
      // First verify that the campaign belongs to the organization
      const campaign = await Campaign.findOne({
        where: {
